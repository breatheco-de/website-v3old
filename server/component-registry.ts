        ...
        try {
          ...
          if (match) {
            ...
            while ((entryMatch = entryRegex.exec(objStr)) !== null) {
              ...
              if (["icon-picker", "color-picker", "image-picker", "image-with-style-picker", "link-picker", "rich-text-editor", "markdown", "boolean-toggle", "variant-picker", "video-picker", "cta-picker", "string-picker", "font-size-picker", "related-features-picker", "faq-visibility-editor"].includes(baseType)) {
